...
| 2 | Splash screen | Working | Splash routes safely into onboarding. |
...
| 6 | Workouts list | Working | Free and Premium plan cards route through warm-up. |
...
| 8 | Workout player | Missing and added | Guided player supports start, pause, resume, next, finish, progress, and safe exit. |
...
| 41 | Export data placeholder | Hidden as Coming Soon | Stable CSV / JSON placeholder only. |
